    ...
    "$defs": {
        ...
        "SetModeRequest": {
            ...
            "properties": {
                ...
                "stt_segmenter": {"enum": ["server", "client"]},
            },
            "additionalProperties": True,
        },
        "ModeReady": {
            ...
            "properties": {
                ...
                "stt_config": {
                    ...
                    "properties": {
                        ...
                        "onnx_asr_model": {"type": "string"},
                        "onnx_asr_model_path": {"type": "string"},
                        "onnx_asr_quantization": {"type": "string"},
                        "onnx_asr_device": {"type": "string", "enum": ["auto", "cpu", "cuda"]},
                        "kroko_url": {"type": "string"},
                        "kroko_language": {"type": "string"},
                        "kroko_port": {"type": "integer"},
                        "kroko_embedded": {"type": "boolean"},
